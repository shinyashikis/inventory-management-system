 ...
 * <p>仕入伝票文書ファイル作成クラス</p>
 */
public class PurchaseDocWriter extends AbstractDocWriter {
	 ...
	 * @param docInfo
	 */
	public PurchaseDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
	...
	public void write() throws DocWriterException {
		...
		InputStream in = null;
		try {
			PurchaseDocInfo quoDocInfo = (PurchaseDocInfo)docInfo;
