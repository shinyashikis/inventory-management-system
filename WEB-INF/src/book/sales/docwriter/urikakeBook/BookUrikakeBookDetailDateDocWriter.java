...
/**
 * 売掛台帳(取引先)(詳細)(日付)出力クラス
 *
 * @author shinyashiki
 *
 */
public class BookUrikakeBookDetailDateDocWriter extends AbstractDocWriter {
	...
	public BookUrikakeBookDetailDateDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
