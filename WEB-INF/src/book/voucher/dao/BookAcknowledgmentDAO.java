...
public class BookAcknowledgmentDAO extends AbstractCommonDAO {

	public static final String SQLID00101 = "BOOK_ACKNOWLEDGMENT_00101";

	public BookAcknowledgmentDAO(Connection conn) {
		super(conn);
	}
	...
	public List<CommonDTO> select(String sql, List<Object> params)
		...
		return DTOUtil.makeDTOList(stmt.executeQuery(), BookAcknowledgmentDTO.class);
	}
