...
/**
 * 仕入台帳(取引先)(詳細)(年度)出力クラス
 *
 * @author shinyashiki
 *
 */
public class BookPurchaseBookDetailYearDocWriter extends AbstractDocWriter {
	...
	public BookPurchaseBookDetailYearDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
