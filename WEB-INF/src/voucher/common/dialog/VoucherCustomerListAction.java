 ...
 * <p>(伝票)得意先一覧アクション</p>
 */
public class VoucherCustomerListAction extends AbstractCommonEventDispatchAction {
	...
	public ActionForward init(ActionMapping mapping, ActionForm form,
		...
		request.getSession(false).setAttribute(
				BizCommonConstants.BEAN_NAME_DEAL_BEAN_MAP, VoucherCustomerBL.getDealBeanMap(targetDealCode, targetVoucherDate));
	...
	public ActionForward close(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		VoucherCustomerListForm listForm = (VoucherCustomerListForm)form;
		...
		request.getSession(false).removeAttribute(BizCommonConstants.FORM_BEAN_NAME_VOUCHER_CUSTOMER_LIST_FORM);
