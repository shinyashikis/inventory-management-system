...
<h5>◆<bean:message key="CUSTOMER_CLASS_LIST.VIEW"/></h5>
...
<html:form action="/CustomerClassListAction">
...
<th class="th01"><bean:message key="CUSTOMER_CLASS_LIST.LABEL.CD"/></th>
<th class="th01"><bean:message key="CUSTOMER_CLASS_LIST.LABEL.NAME"/></th>
<th class="th01"><bean:message key="CUSTOMER_CLASS_LIST.LABEL.KANA"/></th>
</tr>
<logic:notEmpty name="CustomerClassListForm">
<script>var i = 0;</script>
<logic:iterate id="map" name="CustomerClassListForm" property="customerClassMap">
<tr>
<td class="td02"><html:multibox name="CustomerClassListForm" property="sel" onclick="changeBtnStatus();"><bean:write name="map" property="key"></bean:write></html:multibox></td>
