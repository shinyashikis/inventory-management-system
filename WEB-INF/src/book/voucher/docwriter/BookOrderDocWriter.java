 ...
 *
 */
public class BookOrderDocWriter extends AbstractDocWriter {
	...
	public BookOrderDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
	...
	public void write() throws DocWriterException {
		...
		try {
			BookOrderDocInfo bookOrderDocInfo = (BookOrderDocInfo)docInfo;

			in = new BufferedInputStream(new FileInputStream(new File(bookOrderDocInfo.getFormName())));
			...
			Sheet sheet = book.getSheet(bookOrderDocInfo.getSheet());
			book.setActiveSheet(bookOrderDocInfo.getActiveSheet());
			sheet.setSelected(true);
			setData(sheet, (BookOrderDocData)bookOrderDocInfo.getDocData());
			os = new BufferedOutputStream(new FileOutputStream(bookOrderDocInfo.getOutFileName()));
			book.write(os);
	 ...
	 * @param docData
	 */
	private void setData(Sheet sheet, BookOrderDocData docData) {
