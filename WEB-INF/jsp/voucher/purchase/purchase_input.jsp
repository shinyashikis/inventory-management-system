...
<title><bean:message key="SYSTEM.NAME"/>:<bean:message key="PURCHASE_INPUT.VIEW"/></title>
...
<script type="text/javascript" src="<%= request.getContextPath() %>/script/voucher/purchase.js"></script>
...
// 帳票アクションURL
var reportDialogUrl = contextPath + '/PurchaseInputAction.do?print';
</script>
</head>

<body>
<html:form action="/PurchaseInputAction">
...
<tiles:put name="voucher_input_header" value="/WEB-INF/jsp/parts/voucher/purchase/p_purchase_input_header.jsp" />
<tiles:put name="voucher_input_deal" value="/WEB-INF/jsp/parts/voucher/purchase/p_purchase_input_deal.jsp" />
<tiles:put name="voucher_input" value="/WEB-INF/jsp/parts/voucher/purchase/p_purchase_input.jsp" />
<tiles:put name="voucher_input_item_detail" value="/WEB-INF/jsp/parts/voucher/purchase/p_purchase_input_item_detail.jsp" />
<tiles:put name="voucher_input_footer" value="/WEB-INF/jsp/parts/voucher/purchase/p_purchase_input_footer.jsp" />
