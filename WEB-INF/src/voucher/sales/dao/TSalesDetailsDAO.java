...
import voucher.sales.dto.TSalesDetailsDTO;
 ...
 * 売上伝票明細テーブルDAO
 */
public class TSalesDetailsDAO extends AbstractCommonDAO {

	public static final String SQLID001 = "T_SALES_DETAILS_001";
	public static final String SQLID002 = "T_SALES_DETAILS_002";

	public TSalesDetailsDAO(Connection conn) {
		super(conn);
	}
	...
	public List<CommonDTO> select(String sql, List<Object> params)
		...
		return DTOUtil.makeDTOList(stmt.executeQuery(), TSalesDetailsDTO.class);
	}
