...
<bean:message key="MENU.VIEW"/> > <bean:message key="ORDER_LIST.VIEW"/>
</div>

<h5>◆<bean:message key="ORDER_LIST.VIEW"/></h5>
...
<html:form action="/OrderListAction">
...
<tr>
<td class="td02"><html:multibox name="OrderListForm" property="sel" onclick="changeBtnStatus();"><bean:write name="map" property="key"></bean:write></html:multibox></td>
