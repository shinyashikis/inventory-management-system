...
<logic:notEmpty name="VoucherSupplierListForm">
<script type="text/javascript">
var cnt=0;
</script>

<logic:iterate id="map" name="VoucherSupplierListForm" property="supplierMap">
<tr>
...
dealArray[cnt]["customerStaffSei"]='<bean:write name="map" property="value.supplierStaffSei"/>';
dealArray[cnt]["customerStaffName"]='<bean:write name="map" property="value.supplierStaffName"/>';
...
dealArray[cnt]["salePriceDivision"]='';
dealArray[cnt]["calcCalcHasu"]='<bean:write name="map" property="value.calcCalcHasu"/>';
