...
import voucher.quotation.dto.TQuotationDetailsDTO;
 ...
 * 見積書明細テーブルDAO
 */
public class TQuotationDetailsDAO extends AbstractCommonDAO {

	public static final String SQLID001 = "T_QUOTATION_DETAILS_001";
	public static final String SQLID002 = "T_QUOTATION_DETAILS_002";

	public TQuotationDetailsDAO(Connection conn) {
		super(conn);
	}
	...
	public List<CommonDTO> select(String sql, List<Object> params)
		...
		return DTOUtil.makeDTOList(stmt.executeQuery(), TQuotationDetailsDTO.class);
	}
