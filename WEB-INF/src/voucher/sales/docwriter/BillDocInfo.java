 ...
 * <p>請求書文書ファイル情報クラス</p>
 */
public class BillDocInfo extends DocInfo {
	...
	public BillDocInfo() {
		try {
			...
			formName = new StringBuilder(p.getValue(CommonProperties.REPORT_FORM_DIR))
				...
				.append(p.getValue(CommonProperties.REPORT_FORM_FILE_BILL)).toString();

			sheet = p.getValue(CommonProperties.REPORT_FORM_SHEET_BILL);
