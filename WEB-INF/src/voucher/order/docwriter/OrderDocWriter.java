 ...
 * <p>注文書文書ファイル作成クラス</p>
 */
public class OrderDocWriter extends AbstractDocWriter {
	 ...
	 * @param docInfo
	 */
	public OrderDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
	...
	public void write() throws DocWriterException {
		...
		InputStream in = null;
		try {
			OrderDocInfo quoDocInfo = (OrderDocInfo)docInfo;
