 ...
 *
 */
public class BookBillTotalDocWriter extends AbstractDocWriter {
	...
	public BookBillTotalDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
	...
	public void write() throws DocWriterException {
		...
		try {
			BookBillTotalDocInfo bookBillTotalDocInfo = (BookBillTotalDocInfo)docInfo;

			in = new BufferedInputStream(new FileInputStream(new File(bookBillTotalDocInfo.getFormName())));
			...
			Sheet sheet = book.getSheet(bookBillTotalDocInfo.getSheet());
			book.setActiveSheet(bookBillTotalDocInfo.getActiveSheet());
			sheet.setSelected(true);
			setData(sheet, (BookBillTotalDocData)bookBillTotalDocInfo.getDocData());
			os = new BufferedOutputStream(new FileOutputStream(bookBillTotalDocInfo.getOutFileName()));
			book.write(os);
	 ...
	 * @param docData
	 */
	private void setData(Sheet sheet, BookBillTotalDocData docData) {
