...
public class BookOrderDocData implements DocData {

	private static final long serialVersionUID = 3068322236710791924L;
	...
	private Map<String, RowData> rowDataMap = new LinkedHashMap<String, BookOrderDocData.RowData>();
