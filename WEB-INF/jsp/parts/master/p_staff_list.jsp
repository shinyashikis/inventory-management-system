...
<bean:message key="MENU.VIEW"/> > <bean:message key="STAFF_LIST.VIEW"/>
</div>

<h5>◆<bean:message key="STAFF_LIST.VIEW"/></h5>
...
<html:form action="/StaffListAction">
...
<th class="th01"><bean:message key="STAFF_LIST.LABEL.CD"/></th>
<th class="th01"><bean:message key="STAFF_LIST.LABEL.NAME"/></th>
<th class="th01"><bean:message key="STAFF_LIST.LABEL.KANA"/></th>
</tr>
<logic:notEmpty name="StaffListForm">
<logic:iterate id="map" name="StaffListForm" property="staffMap">
<tr>
<td class="td02"><html:multibox name="StaffListForm" property="sel" onclick="changeBtnStatus();"><bean:write name="map" property="key"></bean:write></html:multibox></td>
<td class="td02"><bean:write name="map" property="key"/></td>
<td class="td02"><bean:write name="map" property="value.sei"/> <bean:write name="map" property="value.name"/></td>
<td class="td02"><bean:write name="map" property="value.seiKana"/> <bean:write name="map" property="value.nameKana"/></td>
</tr>
</logic:iterate>
</logic:notEmpty>
</table>
