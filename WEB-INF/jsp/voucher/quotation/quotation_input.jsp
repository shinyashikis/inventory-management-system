...
<title><bean:message key="SYSTEM.NAME"/>:<bean:message key="QUOTATION_INPUT.VIEW"/></title>
...
// 帳票アクションURL
var reportDialogUrl = contextPath + '/QuotationInputAction.do?print';
</script>
</head>

<body>
<html:form action="/QuotationInputAction">
...
<tiles:put name="voucher_input_header" value="/WEB-INF/jsp/parts/voucher/quotation/p_quotation_input_header.jsp" />
<tiles:put name="voucher_input_deal" value="/WEB-INF/jsp/parts/voucher/quotation/p_quotation_input_deal.jsp" />
<tiles:put name="voucher_input" value="/WEB-INF/jsp/parts/voucher/quotation/p_quotation_input.jsp" />
<tiles:put name="voucher_input_item_detail" value="/WEB-INF/jsp/parts/voucher/quotation/p_quotation_input_item_detail.jsp" />
<tiles:put name="voucher_input_footer" value="/WEB-INF/jsp/parts/voucher/quotation/p_quotation_input_footer.jsp" />
