...
public class BookItemStockPriceDocWriter extends AbstractDocWriter {

	public BookItemStockPriceDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
	...
	private void setData(Sheet sheet, BookItemStockDocData docData) {
		...
		for (BookItemStock bookItemStock : docData.getBookItemStockList()) {
			...
			cell.setCellValue(bookItemStock.getPrice().doubleValue());
		}
	}
}
