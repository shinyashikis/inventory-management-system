...
public class BookStorageSumDocData implements DocData {
	private static final long serialVersionUID = -6723973167719617764L;
	...
	private Map<String, RowData> rowDataMap = new LinkedHashMap<String, BookStorageSumDocData.RowData>();
