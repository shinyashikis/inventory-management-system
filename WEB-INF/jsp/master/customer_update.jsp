...
<title><bean:message key="SYSTEM.NAME"/>:<bean:message key="CUSTOMER_UPDATE.VIEW"/></title>
...
<tiles:put name="body" value="/WEB-INF/jsp/parts/master/p_customer_update.jsp" />
