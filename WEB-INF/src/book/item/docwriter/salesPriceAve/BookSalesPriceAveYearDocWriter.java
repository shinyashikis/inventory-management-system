 ...
 *
 */
public class BookSalesPriceAveYearDocWriter extends AbstractDocWriter {
	...
	public BookSalesPriceAveYearDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
	...
	public void write() throws DocWriterException {
		...
		try {
			BookSalesPriceAveDocInfo bookSalesPriceAveDocInfo = (BookSalesPriceAveDocInfo)docInfo;

			in = new BufferedInputStream(new FileInputStream(new File(bookSalesPriceAveDocInfo.getFormName())));
			...
			Sheet sheet = book.getSheet(bookSalesPriceAveDocInfo.getSheet());
			book.setActiveSheet(bookSalesPriceAveDocInfo.getActiveSheet());
			sheet.setSelected(true);
			setData(sheet, (BookSalesPriceAveDocData)bookSalesPriceAveDocInfo.getDocData());
			os = new BufferedOutputStream(new FileOutputStream(bookSalesPriceAveDocInfo.getOutFileName()));
			book.write(os);
	 ...
	 * @param docData
	 */
	private void setData(Sheet sheet, BookSalesPriceAveDocData docData) {
