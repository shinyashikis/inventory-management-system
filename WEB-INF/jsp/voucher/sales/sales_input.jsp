...
<title><bean:message key="SYSTEM.NAME"/>:<bean:message key="SALES_INPUT.VIEW"/></title>
...
<script type="text/javascript" src="<%= request.getContextPath() %>/script/voucher/sales.js"></script>
...
// 帳票アクションURL
var reportDialogUrl = contextPath + '/SalesInputAction.do?print';
</script>
</head>

<body>
<html:form action="/SalesInputAction">
...
<tiles:put name="voucher_input_header" value="/WEB-INF/jsp/parts/voucher/sales/p_sales_input_header.jsp" />
<tiles:put name="voucher_input_deal" value="/WEB-INF/jsp/parts/voucher/sales/p_sales_input_deal.jsp" />
<tiles:put name="voucher_input" value="/WEB-INF/jsp/parts/voucher/sales/p_sales_input.jsp" />
<tiles:put name="voucher_input_item_detail" value="/WEB-INF/jsp/parts/voucher/sales/p_sales_input_item_detail.jsp" />
<tiles:put name="voucher_input_footer" value="/WEB-INF/jsp/parts/voucher/sales/p_sales_input_footer.jsp" />
