 ...
 * <p>(伝票)仕入先DTO</p>
 */
public class VoucherSupplierDTO implements CommonDTO {

	private static final long serialVersionUID = 2047065807667319037L;

	public static final String DEAL_CODE = "dealCode";
	public static final String DEAL_NAME = "dealName";
	public static final String DEAL_KANA = "dealKana";
