 ...
 * 在庫数量推移表文書ファイルデータ
 */
public class BookStockTransitionDocData implements DocData {
	private static final long serialVersionUID = -7098150149773648983L;
	...
	private Map<String, RowData> rowDataMap = new LinkedHashMap<String, BookStockTransitionDocData.RowData>();
