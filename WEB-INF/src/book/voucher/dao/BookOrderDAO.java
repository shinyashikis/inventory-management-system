...
public class BookOrderDAO extends AbstractCommonDAO {

	public static final String SQLID00101 = "BOOK_ORDER_00101";
	...
	public List<CommonDTO> select(String sql, List<Object> params)
		...
		return DTOUtil.makeDTOList(stmt.executeQuery(), BookOrderDTO.class);
	}
