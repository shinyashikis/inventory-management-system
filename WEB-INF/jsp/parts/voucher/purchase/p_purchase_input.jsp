...
<html:text styleId="voucherDate" property="voucherDate" name="PurchaseForm" size="20" maxlength="10" style="ime-mode: disabled;" onblur="if(!checkVoucherDate(this.value)) { this.focus(); }"/>
</td>
</tr>
<tr>
<td class="td01"></td>
...
<td class="td02" style="width:90px;"><html:text property="etc1" name="PurchaseForm" size="40" maxlength="20"/></td>
</tr>
<tr>
<td class="td01"><bean:message key="VOUCHER_INPUT.LABEL.ETC2"/></td>
<td class="td02" style="width:90px;"><html:text property="etc2" name="PurchaseForm" size="40" maxlength="20"/></td>
</tr>
<tr>
<td class="td01"></td>
<td class="td02" style="width:90px;"></td>
...
<td class="td02" rowspan="5"><html:textarea property="memo" name="PurchaseForm" rows="8" cols="50"/></td>
</tr>
</table>
</div>
<!-- ↑↑↑伝票↑↑↑ -->
