...
<title><bean:message key="SYSTEM.NAME"/>:<bean:message key="ORDER_INPUT.VIEW"/></title>
...
<script type="text/javascript" src="<%= request.getContextPath() %>/script/voucher/order.js"></script>
...
//確認メッセージ
var msgCreatePurchase = '<bean:message key="ORDER_INPUT.MSG.CREATE_PURCHASE"/>';
...
// 帳票アクションURL
var reportDialogUrl = contextPath + '/OrderInputAction.do?print';
</script>
</head>

<body>
<html:form action="/OrderInputAction">
...
<tiles:put name="voucher_input_header" value="/WEB-INF/jsp/parts/voucher/order/p_order_input_header.jsp" />
<tiles:put name="voucher_input_deal" value="/WEB-INF/jsp/parts/voucher/order/p_order_input_deal.jsp" />
<tiles:put name="voucher_input" value="/WEB-INF/jsp/parts/voucher/order/p_order_input.jsp" />
<tiles:put name="voucher_input_item_detail" value="/WEB-INF/jsp/parts/voucher/order/p_order_input_item_detail.jsp" />
<tiles:put name="voucher_input_footer" value="/WEB-INF/jsp/parts/voucher/order/p_order_input_footer.jsp" />
