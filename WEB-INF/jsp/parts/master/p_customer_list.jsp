...
<bean:message key="MENU.VIEW"/> > <bean:message key="CUSTOMER_LIST.VIEW"/>
</div>
...
<html:form action="/CustomerListAction">
...
<logic:iterate id="map" name="CustomerListForm" property="customerMap">
<tr>
<td class="td02"><html:multibox name="CustomerListForm" property="sel" onclick="changeBtnStatus();"><bean:write name="map" property="key"></bean:write></html:multibox></td>
