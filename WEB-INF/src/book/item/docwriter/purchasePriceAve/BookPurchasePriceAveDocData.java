...
public class BookPurchasePriceAveDocData implements DocData {

	private static final long serialVersionUID = 9211525808283678612L;
	...
	private Map<String, RowData> rowDataMap = new LinkedHashMap<String, BookPurchasePriceAveDocData.RowData>();
	...
	void setAvePrice(String code, BigDecimal avePrice) {
		createRowData(code);
		rowDataMap.get(code).setAvePrice(avePrice);
	}

	public BigDecimal getAvePrice(String code) {
		return (rowDataMap.get(code) == null)
			? null : rowDataMap.get(code).getAvePrice();
	}
	...
	private class RowData {
		...
		private BigDecimal getAvePrice() {
			return avePrice;
		}
		private void setAvePrice(BigDecimal avePrice) {
