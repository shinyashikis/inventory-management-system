...
<html:text styleId="voucherDate" property="voucherDate" name="QuotationForm" size="20" maxlength="10" style="ime-mode: disabled;" onblur="if(!checkVoucherDate(this.value)) { this.focus(); }"/>
</td>
</tr>
<tr>
<td class="td01"><bean:message key="VOUCHER_INPUT.LABEL.VOUCHER_NAME"/><bean:message key="COMMON.LABEL.HISSU"/></td>
<td class="td02" style="width:90px;"><html:text styleId="voucherName" property="voucherName" name="QuotationForm" size="80" maxlength="40" onblur="if(!checkVoucherName(this.value)) { this.focus(); }"/></td>
</tr>
<tr>
<td class="td01"><bean:message key="VOUCHER_INPUT.LABEL.PAYMENT_LIMIT"/></td>
<td class="td02" style="width:90px;"><html:text property="paymentLimit" name="QuotationForm" size="40" maxlength="20"/></td>
</tr>
<tr>
<td class="td01"><bean:message key="VOUCHER_INPUT.LABEL.PAYMENT_PLACE"/></td>
<td class="td02" style="width:90px;"><html:text property="paymentPlace" name="QuotationForm" size="40" maxlength="20"/></td>
</tr>
<tr>
<td class="td01"><bean:message key="VOUCHER_INPUT.LABEL.PAYMENT_CONDITION"/></td>
<td class="td02" style="width:90px;"><html:text property="paymentCondition" name="QuotationForm" size="40" maxlength="20"/></td>
</tr>
<tr>
<td class="td01"><bean:message key="VOUCHER_INPUT.LABEL.EXPIRATION_DATE"/></td>
<td class="td02" style="width:90px;"><html:text property="expirationDate" name="QuotationForm" size="40" maxlength="20"/></td>
</tr>
<tr>
<td class="td01"></td>
...
<td class="td02" rowspan="5"><html:textarea property="memo" name="QuotationForm" rows="8" cols="50"/></td>
</tr>
</table>
</div>
<!-- ↑↑↑伝票↑↑↑ -->
