...
/**
 * 売上台帳(取引先)(詳細)(日付)文書ファイル情報クラス
 *
 * @author shinyashiki
 *
 */
public class BookSalesBookDetailDateDocInfo extends BookSalesBookDocInfo {
	 ...
	 * コンストラクタ
	 */
	public BookSalesBookDetailDateDocInfo() {
		try {
			// フォーマットファイル名とシート名の指定
			...
			sheet = p.getValue(CommonProperties.BOOK_FORM_SHEET_SALES_BOOK_DETAIL_DATE);
			activeSheet = 1;
