...
<td class="td02" style="width:90px;"><html:text styleId='dealCode' property='dealCode' name='QuotationForm' size='20' maxlength='10' onblur='if(!checkDealCode(this.value)) { this.focus(); } else { searchDeal(this.value); }'/></td>
</tr>
...
<logic:equal property="dealKind" name="QuotationForm" value="<%= ViewProperties.getInstance().getValue(ViewProperties.DEAL_KIND_CUSTOMER, ViewProperties.VALUE) %>" >
<td class="td01"><bean:message key="VOUCHER_INPUT.LABEL.PRICE_DIVISION"/></td>
<td class="td02" style="width:90px;" id="priceDivision"><bean:write property="dealBean.priceDivision" name="VoucherBean"/></td>
</logic:equal>
<logic:equal property="dealKind" name="QuotationForm" value="<%= ViewProperties.getInstance().getValue(ViewProperties.DEAL_KIND_SUPPLIER, ViewProperties.VALUE) %>" >
...
<html:radio styleId="dealKindCustomer" property="dealKind" name="QuotationForm" value="<%= ViewProperties.getInstance().getValue(ViewProperties.DEAL_KIND_CUSTOMER, ViewProperties.VALUE) %>" onclick="changeDeal(this.value);"><bean:message key="COMMON.LABEL.CUSTOMER"/></html:radio>
<html:radio styleId="dealKindSupplier" property="dealKind" name="QuotationForm" value="<%= ViewProperties.getInstance().getValue(ViewProperties.DEAL_KIND_SUPPLIER, ViewProperties.VALUE) %>" onclick="changeDeal(this.value);"><bean:message key="COMMON.LABEL.SUPPLIER"/></html:radio>
</td>
</tr>
