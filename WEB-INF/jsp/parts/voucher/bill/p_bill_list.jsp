...
<bean:message key="MENU.VIEW"/> > <bean:message key="BILL_LIST.VIEW"/>
</div>

<h5>◆<bean:message key="BILL_LIST.VIEW"/></h5>
...
<html:form action="/BillListAction">
...
<tr>
<td class="td02"><html:multibox name="BillListForm" property="sel" onclick="changeBtnStatus();"><bean:write name="map" property="key"></bean:write></html:multibox></td>
