...
<title><bean:message key="SYSTEM.NAME"/>:<bean:message key="SUPPLIER_UPDATE.VIEW"/></title>
...
<tiles:put name="body" value="/WEB-INF/jsp/parts/master/p_supplier_update.jsp" />
