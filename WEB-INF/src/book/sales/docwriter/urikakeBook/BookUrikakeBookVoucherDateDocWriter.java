...
/**
 * 売掛台帳(取引先)(伝票)(日付)出力クラス
 *
 * @author shinyashiki
 *
 */
public class BookUrikakeBookVoucherDateDocWriter extends AbstractDocWriter {
	...
	public BookUrikakeBookVoucherDateDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
