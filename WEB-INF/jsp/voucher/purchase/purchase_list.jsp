...
<title><bean:message key="SYSTEM.NAME"/>:<bean:message key="PURCHASE_LIST.VIEW"/></title>
...
<tiles:put name="body" value="/WEB-INF/jsp/parts/voucher/purchase/p_purchase_list.jsp" />
