...
/**
 * 買掛台帳(取引先)(伝票)(日付)出力クラス
 *
 * @author shinyashiki
 *
 */
public class BookKaikakeBookVoucherDateDocWriter extends AbstractDocWriter {
	...
	public BookKaikakeBookVoucherDateDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
