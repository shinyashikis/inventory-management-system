 ...
 * 仕入伝票FormBean
 */
public class PurchaseForm extends ValidatorForm {
	...
	/** 印刷区分 **/
	private String printKind = ViewProperties.getInstance().getValue(ViewProperties.PRINT_KIND_PURCHASE, ViewProperties.VALUE);
