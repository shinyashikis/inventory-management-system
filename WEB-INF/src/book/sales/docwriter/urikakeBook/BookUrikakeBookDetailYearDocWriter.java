...
/**
 * 売掛台帳(取引先)(詳細)(年度)出力クラス
 *
 * @author shinyashiki
 *
 */
public class BookUrikakeBookDetailYearDocWriter extends AbstractDocWriter {
	...
	public BookUrikakeBookDetailYearDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
