 ...
 * <p>基本設定フォーム</p>
 */
public class BasicForm extends ValidatorForm{
	private static final long serialVersionUID = 4149123502660512202L;
	...
	public ActionErrors validate(ActionMapping mapping,
		...
		if (m.size() == 0 || m.get("init") != null || m.get("back") != null) {
