...
function closeDialog() {
	...
	form.action = '<%= request.getContextPath() %>/BillCustomerListAction.do?close';
	form.submit();
	self.close();
...
<html:form action="/BillCustomerListAction">
...
<logic:notEmpty name="BillCustomerBeanMap">
<logic:iterate id="map" name="BillCustomerBeanMap">
<tr>
