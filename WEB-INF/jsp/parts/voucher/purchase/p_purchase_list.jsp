...
<bean:message key="MENU.VIEW"/> > <bean:message key="PURCHASE_LIST.VIEW"/>
</div>

<h5>◆<bean:message key="PURCHASE_LIST.VIEW"/></h5>
...
<html:form action="/PurchaseListAction">
...
<tr>
<td class="td02"><html:multibox name="PurchaseListForm" property="sel" onclick="changeBtnStatus();"><bean:write name="map" property="key"></bean:write></html:multibox></td>
