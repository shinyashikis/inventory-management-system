...
import voucher.bill.dto.TBillDetailsDTO;
 ...
 * 請求書明細テーブルDAO
 */
public class TBillDetailsDAO extends AbstractCommonDAO {

	public static final String SQLID001 = "T_BILL_DETAILS_001";
	public static final String SQLID002 = "T_BILL_DETAILS_002";

	public TBillDetailsDAO(Connection conn) {
		super(conn);
	}
	...
	public List<CommonDTO> select(String sql, List<Object> params)
		...
		return DTOUtil.makeDTOList(stmt.executeQuery(), TBillDetailsDTO.class);
	}
