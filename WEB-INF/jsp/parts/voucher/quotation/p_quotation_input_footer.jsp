...
<div class="lbl01"><html:radio property="printKind" name="QuotationForm" value="<%= ViewProperties.getInstance().getValue(ViewProperties.PRINT_KIND_QUOTATION, ViewProperties.VALUE) %>">
<%= ViewProperties.getInstance().getValue(ViewProperties.PRINT_KIND_QUOTATION, ViewProperties.DISP_VALUE) %>
</html:radio></div>
