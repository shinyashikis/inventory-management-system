 ...
 * 請求書取引先テーブルDAO
 */
public class TBillDealDAO extends AbstractCommonDAO {

	public static final String SQLID001 = "T_BILL_DEAL_001";
	public static final String SQLID002 = "T_BILL_DEAL_002";
	public static final String SQLID003 = "T_BILL_DEAL_003";

	public TBillDealDAO(Connection conn) {
		super(conn);
	}
