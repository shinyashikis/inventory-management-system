...
<td class="td01"><bean:message key="VOUCHER_INPUT.LABEL.GROSS_PROFIT"/></td>
<td class="td02" style="width:90px;" id="grossProfit"><bean:write property="grossProfit" name="VoucherBean"/></td>
</logic:equal>
...
<td class="td02" style="width:90px;"><html:text styleId="discount" property="discount" name="QuotationForm" size="15" maxlength="11" style="ime-mode: disabled;" onblur="if(!checkDiscount(this.value)) { this.focus(); }"/></td>
...
<logic:iterate id="detail" property="detailList" name="QuotationForm" indexId="idx">
<tr>
