 ...
 * 見積書FormBean
 */
public class QuotationForm extends ValidatorForm {
	...
	/** 伝票名称 */
	private String voucherName = "見積書";
	/** 納入期限 */
	...
	/** 印刷区分 **/
	private String printKind = ViewProperties.getInstance().getValue(ViewProperties.PRINT_KIND_QUOTATION, ViewProperties.VALUE);
