 ...
 * 仕入伝票取引先テーブルDAO
 */
public class TPurchaseDealDAO extends AbstractCommonDAO {

	public static final String SQLID001 = "T_PURCHASE_DEAL_001";
	public static final String SQLID002 = "T_PURCHASE_DEAL_002";
	public static final String SQLID003 = "T_PURCHASE_DEAL_003";

	public TPurchaseDealDAO(Connection conn) {
		super(conn);
	}
