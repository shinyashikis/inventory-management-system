...
public class BookBillTotalDAO extends AbstractCommonDAO {

	public static final String SQLID00101 = "BOOK_BILL_TOTAL_00101";

	public BookBillTotalDAO(Connection conn) {
		super(conn);
	}
	...
	public List<CommonDTO> select(String sql, List<Object> params)
		...
		return DTOUtil.makeDTOList(stmt.executeQuery(), BookBillTotalDTO.class);
	}
