...
/**
 * 仕入台帳(取引先)(伝票)(日付)出力クラス
 *
 * @author shinyashiki
 *
 */
public class BookPurchaseBookVoucherDateDocWriter extends AbstractDocWriter {
	...
	public BookPurchaseBookVoucherDateDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
