...
public class BookSalesTotalDocData implements DocData {

	private static final long serialVersionUID = -3796682562443181629L;

	private String nendo;
	private String from;
	private String to;

	/** 行データ(key:得意先コード、value:RowData **/
	private Map<String, RowData> rowDataMap = new LinkedHashMap<String, BookSalesTotalDocData.RowData>();
