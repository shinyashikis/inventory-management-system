...
/**
 * 仕入台帳(取引先)(伝票)(年度)出力クラス
 *
 * @author shinyashiki
 *
 */
public class BookPurchaseBookVoucherYearDocWriter extends AbstractDocWriter {
	...
	public BookPurchaseBookVoucherYearDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
