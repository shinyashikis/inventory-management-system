...
public class BookKaikakeBookDAO extends AbstractCommonDAO {

	public static final String SQLID00101 = "BOOK_KAIKAKE_BOOK_00101";
	public static final String SQLID00102 = "BOOK_KAIKAKE_BOOK_00102";

	public BookKaikakeBookDAO(Connection conn) {
		super(conn);
	}
	...
	public List<CommonDTO> select(String sql, List<Object> params)
		...
		return DTOUtil.makeDTOList(stmt.executeQuery(), BookKaikakeBookDTO.class);
	}
