...
public class BookUrikakeBookDAO extends AbstractCommonDAO {

	public static final String SQLID00101 = "BOOK_URIKAKE_BOOK_00101";
	public static final String SQLID00102 = "BOOK_URIKAKE_BOOK_00102";

	public BookUrikakeBookDAO(Connection conn) {
		super(conn);
	}
	...
	public List<CommonDTO> select(String sql, List<Object> params)
		...
		return DTOUtil.makeDTOList(stmt.executeQuery(), BookUrikakeBookDTO.class);
	}
