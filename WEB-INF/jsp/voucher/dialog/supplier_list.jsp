...
<title><bean:message key="SYSTEM.NAME"/>:<bean:message key="SUPPLIER_LIST.VIEW"/></title>
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/common.css" type="text/css"/>
<script type="text/javascript" src="<%= request.getContextPath() %>/script/common.js"></script>
<script type="text/javascript" src="<%= request.getContextPath() %>/script/voucher.js"></script>
<base target="_self">
</head>
<tiles:insert template="/WEB-INF/jsp/template/dialog.jsp">
<tiles:put name="body" value="/WEB-INF/jsp/parts/voucher/dialog/p_supplier_list.jsp" />
</tiles:insert>
</html:html>
