...
/**
 * 買掛台帳(取引先)(詳細)(日付)出力クラス
 *
 * @author shinyashiki
 *
 */
public class BookKaikakeBookDetailDateDocWriter extends AbstractDocWriter {
	...
	public BookKaikakeBookDetailDateDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
