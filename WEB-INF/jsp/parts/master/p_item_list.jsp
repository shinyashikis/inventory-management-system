...
<bean:message key="MENU.VIEW"/> > <bean:message key="ITEM_LIST.VIEW"/>
</div>
...
<html:form action="/ItemListAction">
...
<logic:notEmpty name="ItemListForm">
<logic:iterate id="map" name="ItemListForm" property="itemMap">
<tr>
<td class="td02"><html:multibox name="ItemListForm" property="sel" onclick="changeBtnStatus();"><bean:write name="map" property="key"></bean:write></html:multibox></td>
