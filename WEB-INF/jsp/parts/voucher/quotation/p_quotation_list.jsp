...
<bean:message key="MENU.VIEW"/> > <bean:message key="QUOTATION_LIST.VIEW"/>
</div>

<h5>◆<bean:message key="QUOTATION_LIST.VIEW"/></h5>
...
<html:form action="/QuotationListAction">
...
<tr>
<td class="td02"><html:multibox name="QuotationListForm" property="sel" onclick="changeBtnStatus();"><bean:write name="map" property="key"></bean:write></html:multibox></td>
