...
<td class="td02" style="width:90px;"><html:text styleId="discount" property="discount" name="SalesForm" size="15" maxlength="11" style="ime-mode: disabled;" onblur="if(!checkDiscount(this.value)) { this.focus(); }"/></td>
...
<logic:iterate id="detail" property="detailList" name="SalesForm" indexId="idx">
<tr>
