...
<title><bean:message key="SYSTEM.NAME"/>:<bean:message key="ITEM_CLASS_LIST.VIEW"/></title>
...
<tiles:put name="body" value="/WEB-INF/jsp/parts/master/p_item_class_list.jsp" />
</tiles:insert>
</html:html>
