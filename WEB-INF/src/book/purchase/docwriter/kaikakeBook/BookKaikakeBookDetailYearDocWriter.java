...
/**
 * 買掛台帳(取引先)(詳細)(年度)出力クラス
 *
 * @author shinyashiki
 *
 */
public class BookKaikakeBookDetailYearDocWriter extends AbstractDocWriter {
	...
	public BookKaikakeBookDetailYearDocWriter(DocInfo docInfo) {
		super(docInfo);
	}
