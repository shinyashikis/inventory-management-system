...
<title><bean:message key="SYSTEM.NAME"/>:<bean:message key="SUPPLIER_CLASS_UPDATE.VIEW"/></title>
...
<tiles:put name="body" value="/WEB-INF/jsp/parts/master/p_supplier_class_update.jsp" />
</tiles:insert>
</html:html>
