 ...
 * 売上伝票取引先テーブルDAO
 */
public class TSalesDealDAO extends AbstractCommonDAO {

	public static final String SQLID001 = "T_SALES_DEAL_001";
	public static final String SQLID002 = "T_SALES_DEAL_002";
	public static final String SQLID003 = "T_SALES_DEAL_003";

	public TSalesDealDAO(Connection conn) {
		super(conn);
	}
