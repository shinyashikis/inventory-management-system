...
public class BookSalesBookDocData implements DocData {

	private static final long serialVersionUID = -5290625423218304405L;
	...
	void setSalesPrice(int index, BigDecimal salesPrice) {
		createRowData(index);
		rowDataList.get(index).setSalesPrice(salesPrice);
	}

	public BigDecimal getSalesPrice(int index) {
		return (rowDataList.get(index) == null)
			? null : rowDataList.get(index).getSalesPrice();
	}
	...
	void setGross(int index, BigDecimal gross) {
		createRowData(index);
		rowDataList.get(index).setGross(gross);
	}

	public BigDecimal getGross(int index) {
		return (rowDataList.get(index) == null)
			? null : rowDataList.get(index).getGross();
	}
	...
	void setItemPurchasePrice(int index, BigDecimal itemPurchasePrice) {
		createRowData(index);
		rowDataList.get(index).setItemPurchasePrice(itemPurchasePrice);
	}

	public BigDecimal getItemPurchasePrice(int index) {
		return (rowDataList.get(index) == null)
			? null : rowDataList.get(index).getItemPurchasePrice();
	}
	...
	private class RowData {
		...
		private BigDecimal getSalesPrice() {
			return salesPrice;
		}
		private void setSalesPrice(BigDecimal salesPrice) {
		...
		private BigDecimal getItemPurchasePrice() {
			return itemPurchasePrice;
		}
		private void setItemPurchasePrice(BigDecimal itemPurchasePrice) {
